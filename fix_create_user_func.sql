-- =============================================
-- FIX: mise à jour de la fonction create_user_by_admin
-- Cause de l'erreur précédente : tentative d'insertion de 'email' dans la table 'profiles'
-- =============================================
